...
casalog.setlogfile('casa5_data_pysynthesisimager_clean_500_0-13_mosaic_psfonly_notparall.log')
...
print ("makePSF!")
write_f=open('casa5_data_pysynthesisimager_clean_500_0-13_mosaic_psfonly_notparall.log', 'a')
