...
from casatasks.private.imagerhelpers.input_parameters import ImagerParameters     # Step (1)

## print into defined logfile
casalog.setlogfile('casa6_fam_clean_split_10000_0-13_mosaic_not_parallel.log')
...
print ("makePSF!")
write_f=open('casa6_fam_clean_split_10000_0-13_mosaic_not_parallel.log', 'a')
