...
int main(int argc, char **argv){
    ...
    folder = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/");
    if(folder == NULL)
    {
    ...
    while( (entry=readdir(folder)) )
    {
      ...
      //  char strsub[] = "SUBMSS";
        ...
        if (strcmp(fileName, str1) == 0){
          ...
          folder2 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/SOURCE");
          if(folder2 == NULL)
          {
              perror("Unable to read directory");
              return(1);
          ...
          {//while folder2 folder SOURCE
            ...
            char format_s[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
            ...
            char format_s_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
          ...
          folder3 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/POINTING");
          if(folder3 == NULL)
          {
              perror("Unable to read directory");
              return(1);
          ...
          {//while folder3 folder POINTING
            ...
            //source sfd in writer_results.c in a variable stored
            char format_p[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
            char filename_p[sizeof format_p+100];
            sprintf(filename_p,format_p,fileName,fileName3);
            printf("%s\n", filename_p );

            //destination dfd in writer_results.c stored in a variable
            char format_p_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
        ...
        closedir(folder3);
          ...
          folder4 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/HISTORY");
          if(folder4 == NULL)
          {
              perror("Unable to read directory");
              return(1);
          ...
          {//while folder4 folder HISTORY
            ...
            //source sfd in writer_results.c in a variable stored
            char format_h[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
            char filename_h[sizeof format_h+100];
            sprintf(filename_h,format_h,fileName,fileName5);
            printf("%s\n", filename_h );

            //destination dfd in writer_results.c stored in a variable
            char format_h_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
        ...
        folder5 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/ASDM_CALWVR");
        if(folder5 == NULL)
        {
            perror("Unable to read directory");
            return(1);
        ...
        {//while folder4 folder HISTORY
          ...
          //source sfd in writer_results.c in a variable stored
          char format_as[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
          char filename_as[sizeof format_as+100];
          sprintf(filename_as,format_as,fileName,fileName6);
          printf("%s\n", filename_as );

          //destination dfd in writer_results.c stored in a variable
          char format_as_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
      ...
      folder6 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/SYSCAL");
      if(folder6 == NULL)
      {
          perror("Unable to read directory");
          return(1);
      ...
      {//while folder6 folder HISTORY
        ...
        //source sfd in writer_results.c in a variable stored
        char format_sy[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
        char filename_sy[sizeof format_sy+100];
        sprintf(filename_sy,format_sy,fileName,fileName7);
        printf("%s\n", filename_sy );

        //destination dfd in writer_results.c stored in a variable
        char format_sy_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
    ...
    folder7 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/OBSERVATION");
    if(folder7 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder7 folder OBSERVATION
      ...
      //source sfd in writer_results.c in a variable stored
      char format_o[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_o[sizeof format_o+100];
      sprintf(filename_o,format_o,fileName,fileName8);
      printf("%s\n", filename_o );

      //destination dfd in writer_results.c stored in a variable
      char format_o_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  //else if (strcmp(fileName, strsub)==0) {
    ...
    //folderSUB = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/SUBMSS");
    //if(folderSUB == NULL)
    //{
      //  perror("Unable to read directory");
        //return(1);
  ...
  // SUBMS end here
    ...
    folder8 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/SORTED_TABLE");
    if(folder8 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder8 folder SORTED_TABLE
      ...
      //source sfd in writer_results.c in a variable stored
      char format_st[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_st[sizeof format_st+100];
      sprintf(filename_st,format_st,fileName,fileName9);
      printf("%s\n", filename_st );

      //destination dfd in writer_results.c stored in a variable
      char format_st_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder8);
    ...
    folder9 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/WEATHER");
    if(folder9 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder9 folder SORTED_TABLE
      ...
      //source sfd in writer_results.c in a variable stored
      char format_w[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_w[sizeof format_w+100];
      sprintf(filename_w,format_w,fileName,fileName10);
      printf("%s\n", filename_w );

      //destination dfd in writer_results.c stored in a variable
      char format_w_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder9);
    ...
    folder10 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/FIELD");
    if(folder10 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder10 folder FIELD
      ...
      //source sfd in writer_results.c in a variable stored
      char format_fie[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_fie[sizeof format_fie+100];
      sprintf(filename_fie,format_fie,fileName,fileName11);
      printf("%s\n", filename_fie );

      //destination dfd in writer_results.c stored in a variable
      char format_fie_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder10);
    ...
    folder11 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/FLAG_CMD");
    if(folder11 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder11 folder FLAG_CMD
      ...
      //source sfd in writer_results.c in a variable stored
      char format_flag[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_flag[sizeof format_flag+100];
      sprintf(filename_flag,format_flag,fileName,fileName12);
      printf("%s\n", filename_flag );

      //destination dfd in writer_results.c stored in a variable
      char format_flag_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder11);
    ...
    folder12 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/SYSPOWER");
    if(folder12 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder12 folder SYSPOWER
      ...
      //source sfd in writer_results.c in a variable stored
      char format_sysp[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_sysp[sizeof format_sysp+100];
      sprintf(filename_sysp,format_sysp,fileName,fileName13);
      printf("%s\n", filename_sysp );

      //destination dfd in writer_results.c stored in a variable
      char format_sysp_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder12);
    ...
    folder13 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/CALDEVICE");
    if(folder13 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder13 folder CALDEVICE
      ...
      //source sfd in writer_results.c in a variable stored
      char format_cal[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_cal[sizeof format_cal+100];
      sprintf(filename_cal,format_cal,fileName,fileName14);
      printf("%s\n", filename_cal );

      //destination dfd in writer_results.c stored in a variable
      char format_cal_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder13);
    ...
    folder14 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/ANTENNA");
    if(folder14 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder14 folder ANTENNA
      ...
      //source sfd in writer_results.c in a variable stored
      char format_ant[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_ant[sizeof format_ant+100];
      sprintf(filename_ant,format_ant,fileName,fileName15);
      printf("%s\n", filename_ant );

      //destination dfd in writer_results.c stored in a variable
      char format_ant_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder14);
    ...
    folder15 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/ASDM_RECEIVER");
    if(folder15 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder15 folder ASDM_RECEIVER
      ...
      //source sfd in writer_results.c in a variable stored
      char format_asr[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_asr[sizeof format_asr+100];
      sprintf(filename_asr,format_asr,fileName,fileName16);
      printf("%s\n", filename_asr );

      //destination dfd in writer_results.c stored in a variable
      char format_asr_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder15);
    ...
    folder16 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/SPECTRAL_WINDOW");
    if(folder16 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder16 folder SPECTRAL_WINDOW
      ...
      //source sfd in writer_results.c in a variable stored
      char format_spw[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_spw[sizeof format_spw+100];
      sprintf(filename_spw,format_spw,fileName,fileName17);
      printf("%s\n", filename_spw );

      //destination dfd in writer_results.c stored in a variable
      char format_spw_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder16);
    ...
    folder17 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/POLARIZATION");
    if(folder17 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder17 folder POLARIZATION
      ...
      //source sfd in writer_results.c in a variable stored
      char format_pol[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_pol[sizeof format_pol+100];
      sprintf(filename_pol,format_pol,fileName,fileName18);
      printf("%s\n", filename_pol );

      //destination dfd in writer_results.c stored in a variable
      char format_pol_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder17);
    ...
    folder18 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/ASDM_ANTENNA");
    if(folder18 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder18 folder ASDM_ANTENNA
      ...
      //source sfd in writer_results.c in a variable stored
      char format_aa[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_aa[sizeof format_aa+100];
      sprintf(filename_aa,format_aa,fileName,fileName19);
      printf("%s\n", filename_aa );

      //destination dfd in writer_results.c stored in a variable
      char format_aa_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder18);
    ...
    folder19 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/ASDM_STATION");
    if(folder19 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder19 folder ASDM_STATION
      ...
      //source sfd in writer_results.c in a variable stored
      char format_ast[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_ast[sizeof format_ast+100];
      sprintf(filename_ast,format_ast,fileName,fileName20);
      printf("%s\n", filename_ast );

      //destination dfd in writer_results.c stored in a variable
      char format_ast_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder19);
    ...
    folder20 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/STATE");
    if(folder20 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder20 folder STATE
      ...
      //source sfd in writer_results.c in a variable stored
      char format_state[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_state[sizeof format_state+100];
      sprintf(filename_state,format_state,fileName,fileName21);
      printf("%s\n", filename_state );

      //destination dfd in writer_results.c stored in a variable
      char format_state_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder20);
    ...
    folder21 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/FEED");
    if(folder21 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder21 folder FEED
      ...
      //source sfd in writer_results.c in a variable stored
      char format_FEED[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_FEED[sizeof format_FEED+100];
      sprintf(filename_FEED,format_FEED,fileName,fileName22);
      printf("%s\n", filename_FEED );

      //destination dfd in writer_results.c stored in a variable
      char format_FEED_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder21);
    ...
    folder22 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/DATA_DESCRIPTION");
    if(folder22 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder22 folder DATA_DESCRIPTION
      ...
      //source sfd in writer_results.c in a variable stored
      char format_DATA_DESCRIPTION[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      ...
      //destination dfd in writer_results.c stored in a variable
      char format_DATA_DESCRIPTION_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
  ...
  closedir(folder22);
    ...
    folder23 = opendir("/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/PROCESSOR");
    if(folder23 == NULL)
    {
        perror("Unable to read directory");
        return(1);
    ...
    {//while folder23 folder PROCESSOR
      ...
      //source sfd in writer_results.c in a variable stored
      char format_PROCESSOR[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s/%s";
      char filename_PROCESSOR[sizeof format_PROCESSOR+100];
      sprintf(filename_PROCESSOR,format_PROCESSOR,fileName,fileName24);
      printf("%s\n", filename_PROCESSOR );

      //destination dfd in writer_results.c stored in a variable
      char format_PROCESSOR_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s/%s";
...
//insert
      ...
      //source sfd in writer_results.c in a variable stored
      char format[] = "/home/mtrattner/casa/workspace/sis14_twhya_calibrated_flagged.ms/%s";
      char filename[sizeof format+100];
      sprintf(filename,format,fileName);
      printf("%s\n", filename );

      //destination dfd in writer_results.c stored in a variable
      char format_dfd[] = "/lfs/mtrattner/sis14_twhya_calibrated_flagged.ms/%s";
